...
# DAG
video_workflow = DAG(
    dag_id='video-workflow',
    description='Creates AIPs for video containers',
...
# Tasks
collect_video_files = PythonOperator(
    task_id='collect_video_files',
...
retrigger_dag = TriggerDagRunOperator(
    task_id='restart_dag',
    trigger_dag_id='video-workflow',
    python_callable=retrigger_dag,
    dag=video_workflow)

# Flow
collect_video_files.set_downstream(create_directories)
